...
Route::prefix('mikrotik')->group(function () {
    Route::get('/pending-credentials', [MikrotikController::class, 'getPendingCredentials']);
    Route::post('/bookings/status', [MikrotikController::class, 'updateHotspotStatus']);
    Route::post('/profiles/sync', [MikrotikController::class, 'syncProfiles']);
});
